<template>
	<div>
		...
		<el-table :data="items">
			...
			<el-table-column prop="title" label="英雄称号" width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="180">
				<template slot-scope="scope">
					<!-- scope.row表示当前这一行 -->
					<el-button @click="$router.push(`/heroes/edit/${scope.row._id}`)" type="primary" native-type="button" size="small" plain>编辑</el-button>
