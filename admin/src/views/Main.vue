<template>
	<el-container style="height: 100vh; border: 1px solid #eee">
		<el-aside width="200px" style="background-color: rgb(238, 241, 246)">
			<el-menu router unique-opened :default-active="$route.path"><!-- unique-opened一次只能展开一个，:default-active="$route.path"点开的那个高亮 -->
				<!-- :default-openeds="['1']" -->
				<el-submenu index="1">
				...
				<el-submenu index="3">
					<template slot="title"><i class="el-icon-star-off"></i>运营管理</template>
